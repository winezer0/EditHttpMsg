...
public class YamlReader {
    ...
    private YamlReader(IBurpExtenderCallbacks callbacks) throws FileNotFoundException, UnsupportedEncodingException {
        String yamlName = "edit_http_msg.config.yml";
        String config = getExtensionFilePath(callbacks) + yamlName;
        ...
        if(file.exists()){
            ...
            InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream(yamlName);
